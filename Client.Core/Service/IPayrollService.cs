...
public interface IPayrollService : ICrudService<IPayroll, TenantServiceContext, Query>, IAttributeService<TenantServiceContext>
{
    ...
    /// <param name="context">The service context</param>
    /// <param name="caseType">The case type</param>
    /// <param name="employeeId">The employee id; null returns all employees (Employee case type only)</param>
    /// <param name="caseFieldNames">The case field names</param>
    ...
    /// <param name="forecast">The forecast name; null = real values only</param>
    ...
    Task<List<CaseValue>> GetCaseTimeValuesAsync(PayrollServiceContext context, CaseType caseType,
        ...
        DateTime? regulationDate = null, DateTime? evaluationDate = null, string forecast = null);

...
public interface ICompanyCaseChangeService : IReadService<ICaseChange, TenantServiceContext, CaseChangeQuery>
{
    ...
    /// <summary>Get company case change by division</summary>
    /// <param name="context">The service context</param>
